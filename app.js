...
// 环境变量
const UUID = process.env.UUID || 'a2056d0d-ceee-4aeb-9aab-37f64edd5710'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'sOq90vA8wAdW4fLKaE4JBTZqAmgvRcd8';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
